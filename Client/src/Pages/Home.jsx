...
const Home = () => {
  ...
  const [totalDoses, setTotalDoses] = useState(null);
  // ✅ Fetch performer count from backend
  useEffect(() => {
  ...
  const features = [
    {
      ...
      description:
        "Align your medicine schedule with your body's natural rhythms and performance cycles.",
    },
    {
      icon: Shield,
      title: "Wellness Protection",
      description:
        "Never miss a dose with mystical reminders and protective health monitoring.",
    },
    {
      icon: Flame,
      title: "Energy Alchemy",
      description:
        "Transform your vitality with personalized wellness potions and supplement tracking.",
    },
    {
      icon: TrendingUp,
      title: "Performance Insights",
      description:
        "Unlock patterns in your health data to optimize your artistic performance.",
    },
  ];

  const stats = [
    { label: "Performers Served", value: totalUser ? `${totalUser}+` : "..." },
    { label: "Doses Tracked", value: totalDoses ? `${totalDoses}+` : "..." },
    ...
    <div className="relative min-h-screen bg-gradient-to-b from-gray-900 via-purple-900 to-gray-900 text-white overflow-hidden">
      ...
      <div className="relative z-10 space-y-16 px-4 py-8 md:px-8">
          ...
          <div className="magical-glow rounded-3xl p-8 md:p-16 backdrop-blur-sm bg-black/30 border border-purple-500/20">
            <div className="max-w-4xl mx-auto text-center">
              ...
              <p className="text-xl md:text-2xl text-purple-200 mb-8 max-w-3xl mx-auto leading-relaxed">
                Ancient wisdom meets modern medicine. Track your wellness
                journey, manage your medicine schedules, and unlock your peak
        ...
        <section className="flex justify-center">
          <div className="max-w-4xl w-full mx-auto grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-8 justify-items-center">
            {stats.map((stat, index) => (
              <div
                key={index}
                className="text-center group bg-gradient-to-br from-purple-900/30 to-pink-900/10 p-6 rounded-2xl border border-purple-500/20 hover:border-purple-400/40 transition-all duration-300 hover:scale-105"
              >
        ...
        <section>
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-purple-200 max-w-3xl mx-auto">
              Harness ancient wisdom and modern technology to master your
              wellness journey as a performer.
            </p>
          </div>
